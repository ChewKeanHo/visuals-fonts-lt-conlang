# LyonsType's Conlang (`LT Conlang`) Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

LyonsType's Conlang (`LT Conlang`) is a Latin (ID: `*Latn`) Display font
designed by
[The LyonsType's Conlang Project Team](https://lyonstype.neocities.org/fonts).
Its design is based on crafted rounded geometrical symbols that present each
character like an alien-like text. There are 2 families:

* `LT Conlang` - standard typeface
* `LT Conlang Round` - rounded typeface
...
```
Title: LyonsType's Conlang (LT Conlang) Font
Creators: The LyonsType's Conlang Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-lt-conlang
UUID: FE78C3D0-DE5F-41D3-843A-8595FC219B39
...
Procure: https://github.com/ChewKeanHo/visuals-fonts-lt-conlang
```
